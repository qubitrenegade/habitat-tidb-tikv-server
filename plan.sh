...
pkg_license=("MPL-2.0")
pkg_source=https://github.com/pingcap/${pkg_name}/archive/v${pkg_version}.tar.gz
pkg_filename=${pkg_name}-${pkg_version}.tar.gz
pkg_shasum=19ef47fb9457c393dda767b08c50da092ef3292275fa1a12f1d4dc951096d36b
pkg_deps=(
  core/bash
  core/glibc
  core/gcc-libs
...
# pkg_build_deps=(core/make core/gcc core/rust)
